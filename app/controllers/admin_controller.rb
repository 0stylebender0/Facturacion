class AdminController < ApplicationController
  ...
  def comprar_stock
    ...
    producto.save
    redirect_to admin_stock_path, notice: "Stock actualizado para #{producto.Nombre}"
  end
  ...
  def crear_producto
    ...
    redirect_to admin_stock_path, notice: "Producto creado correctamente"
  end
  ...
  def agregar_impuesto
    ...
    redirect_to admin_editar_impuesto_path(id: params[:id_producto]), notice: "Impuesto agregado correctamente"
  end
  ...
  def eliminar_impuesto
    ...
    redirect_to admin_editar_impuesto_path(id: params[:id_producto]), notice: "Impuesto eliminado correctamente"
  end
  ...
  def crear_impuesto
    ...
    redirect_to admin_impuesto_path, notice: "Impuesto creado correctamente"
  end
  ...
  def actualizar_impuesto
    ...
    redirect_to admin_impuesto_path, notice: "Impuesto actualizado correctamente"
  end

  def editar_impuesto
    if params[:id] == "new"
      # Redirige a la creación de nuevo impuesto
  ...
  def require_admin
    unless session[:admin_username]
      redirect_to admin_login_form_path, alert: 'Por favor, inicia sesión como administrador'
    end
  end
end
